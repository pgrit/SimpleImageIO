...
namespace SimpleImageIO {
    /// <summary>
    /// A simple morphological dilation filter
    /// </summary>
    public class DilationFilter {
        ...
        /// <summary>
        /// Applies the dilation filter. The two images cannot be the same.
        /// </summary>
        ...
        /// <summary>
        /// Applies the dilation filter with radius=1 to the original image and writes the result to target. The two images cannot be the same.
        /// </summary>
        /// <param name="original">The original image. Will not be modified.</param>
        /// <param name="target">The target image the result will be written to. Has to be a different object but equal size.</param>
